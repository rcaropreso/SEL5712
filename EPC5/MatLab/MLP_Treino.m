...
W_1 = rand(15, 5); %15 neurons = 15 linhas; (4 entradas + 1 bias) = 5 colunas 
W_2 = rand(3, 16); %Matriz de pesos da camada 2 - 1 neuron = 1 linha; cada coluna é uma sinapse e tem que incluir o bias da camada anterior (16 colunas)
...
while (epson < difEQM && epoca < max_epocas)
    ...
    for k=1:N_amostras
        ...
        delta_2 = GradienteLocalDeSaida( size_Camada_Saida, d, Y_2 );
        ...
        delta_1 = GradienteLocalIntermediario( size_Camada_Oculta, size_Camada_Saida, delta_2, W_2, Y_1 );
